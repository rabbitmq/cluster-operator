...
import (
	...
	"github.com/pivotal/rabbitmq-for-kubernetes/pkg/client/clientset/versioned/scheme"
...
type RabbitmqV1beta1Interface interface {
	...
	RabbitmqClustersGetter
}

// RabbitmqV1beta1Client is used to interact with features provided by the rabbitmq.pivotal.io group.
type RabbitmqV1beta1Client struct {
	restClient rest.Interface
}

func (c *RabbitmqV1beta1Client) RabbitmqClusters(namespace string) RabbitmqClusterInterface {
	return newRabbitmqClusters(c, namespace)
}
