...
type RabbitmqClusterSpec struct {
	...
	// If unset, or set to false, the cluster will run `rabbitmq-upgrade post_upgrade` whenever the cluster is updated.
	...
	SkipPostUpgradeSteps bool `json:"skipPostUpgradeSteps,omitempty"`
}
