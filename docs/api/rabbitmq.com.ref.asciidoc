...
.Resource Types
- xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqcluster[$$RabbitmqCluster$$]
- xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqclusterlist[$$RabbitmqClusterList$$]


=== Definitions

[id="{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-embeddedlabelsannotations"]
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-service[$$Service$$]
- xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-statefulset[$$StatefulSet$$]
****
...
[id="{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-embeddedobjectmeta"]
==== EmbeddedObjectMeta 
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-persistentvolumeclaim[$$PersistentVolumeClaim$$]
- xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-podtemplatespec[$$PodTemplateSpec$$]
****
...
[id="{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-persistentvolumeclaim"]
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-statefulsetspec[$$StatefulSetSpec$$]
****
...
| *`metadata`* __xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-embeddedobjectmeta[$$EmbeddedObjectMeta$$]__ | Refer to Kubernetes API documentation for fields of `metadata`.
...
[id="{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-plugin"]
==== Plugin (string) 
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqclusterconfigurationspec[$$RabbitmqClusterConfigurationSpec$$]
****



[id="{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-podtemplatespec"]
==== PodTemplateSpec 
...
[id="{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqcluster"]
==== RabbitmqCluster 
...
| *`spec`* __xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqclusterspec[$$RabbitmqClusterSpec$$]__ | Spec is the desired state of the RabbitmqCluster Custom Resource.
| *`status`* __xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqclusterstatus[$$RabbitmqClusterStatus$$]__ | Status presents the observed state of RabbitmqCluster
|===


[id="{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqclusterconfigurationspec"]
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqclusterspec[$$RabbitmqClusterSpec$$]
****

[cols="25a,75a", options="header"]
|===
| Field | Description
| *`additionalPlugins`* __xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-plugin[$$Plugin$$] array__ | List of plugins to enable in addition to essential plugins: rabbitmq_management, rabbitmq_prometheus, and rabbitmq_peer_discovery_k8s.
...
[id="{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqclusterdefaultuser"]
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqclusterstatus[$$RabbitmqClusterStatus$$]
****

[cols="25a,75a", options="header"]
|===
| Field | Description
| *`secretReference`* __xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqclustersecretreference[$$RabbitmqClusterSecretReference$$]__ | Reference to the Kubernetes Secret containing the credentials of the default user.
| *`serviceReference`* __xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqclusterservicereference[$$RabbitmqClusterServiceReference$$]__ | Reference to the Kubernetes Service serving the cluster.
|===


[id="{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqclusterlist"]
==== RabbitmqClusterList 
...
| *`items`* __xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqcluster[$$RabbitmqCluster$$]__ | Array of RabbitmqCluster resources.
|===


[id="{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqclusteroverridespec"]
...
|===
| Field | Description
| *`statefulSet`* __xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-statefulset[$$StatefulSet$$]__ | Override configuration for the RabbitMQ StatefulSet.
| *`service`* __xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-service[$$Service$$]__ | Override configuration for the Service created to serve traffic to the cluster.
|===


[id="{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqclusterpersistencespec"]
...
[id="{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqclustersecretreference"]
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqclusterdefaultuser[$$RabbitmqClusterDefaultUser$$]
****
...
[id="{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqclusterservicereference"]
...
[id="{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqclusterservicespec"]
...
[id="{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqclusterspec"]
==== RabbitmqClusterSpec 
...
| *`service`* __xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqclusterservicespec[$$RabbitmqClusterServiceSpec$$]__ | The desired state of the Kubernetes Service to create for the cluster.
| *`persistence`* __xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqclusterpersistencespec[$$RabbitmqClusterPersistenceSpec$$]__ | The desired persistent storage configuration for each Pod in the cluster.
...
| *`rabbitmq`* __xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqclusterconfigurationspec[$$RabbitmqClusterConfigurationSpec$$]__ | Configuration options for RabbitMQ Pods created in the cluster.
| *`tls`* __xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-tlsspec[$$TLSSpec$$]__ | TLS-related configuration for the RabbitMQ cluster.
| *`override`* __xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqclusteroverridespec[$$RabbitmqClusterOverrideSpec$$]__ | Provides the ability to override the generated manifest of several child resources.
...
| *`messagingTopologyNamespaces`* __string array__ | The list of namespaces to allow messaging topology resources to be created from. If one is not defined messaging topology resources can only be created in the same namespace as the cluster.
|===


[id="{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqclusterstatus"]
...
| *`defaultUser`* __xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqclusterdefaultuser[$$RabbitmqClusterDefaultUser$$]__ | Identifying information on internal resources
...
[id="{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-service"]
==== Service 
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-rabbitmqclusteroverridespec[$$RabbitmqClusterOverrideSpec$$]
****

[cols="25a,75a", options="header"]
|===
| Field | Description
| *`metadata`* __xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-embeddedlabelsannotations[$$EmbeddedLabelsAnnotations$$]__ | Refer to Kubernetes API documentation for fields of `metadata`.
...
[id="{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-statefulset"]
==== StatefulSet 
...
| *`spec`* __xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-statefulsetspec[$$StatefulSetSpec$$]__ | Spec defines the desired identities of pods in this set.
|===


[id="{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-statefulsetspec"]
==== StatefulSetSpec 
...
| *`template`* __xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-podtemplatespec[$$PodTemplateSpec$$]__ | template is the object that describes the pod that will be created if insufficient replicas are detected. Each pod stamped out by the StatefulSet will fulfill this Template, but have a unique identity from the rest of the StatefulSet.
| *`volumeClaimTemplates`* __xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-persistentvolumeclaim[$$PersistentVolumeClaim$$] array__ | volumeClaimTemplates is a list of claims that pods are allowed to reference. The StatefulSet controller is responsible for mapping network identities to claims in a way that maintains the identity of a pod. Every claim in this list must have at least one matching (by name) volumeMount in one container in the template. A claim in this list takes precedence over any volumes in the template, with the same name.
...
[id="{anchor_prefix}-github-com-rabbitmq-cluster-operator-api-v1beta2-tlsspec"]
==== TLSSpec 
