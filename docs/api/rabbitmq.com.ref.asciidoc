...
| *`spec`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.23/#statefulsetspec-v1-apps[$$StatefulSetSpec$$]__ | Spec defines the desired identities of pods in this set.
|===
