...
- Accessing the management dashboard/API over HTTPS
...
And I specify the location of a valid cacertfile, certfile and private key file in the Custom Resource
